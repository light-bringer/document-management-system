...
import com.ezdms.api.OKMPropertyGroup;
import com.ezdms.api.OKMRepository;
import com.ezdms.bean.AppVersion;
...
import com.ezdms.bean.ExtendedAttributes;
import com.ezdms.bean.Folder;
import com.ezdms.bean.LockInfo;
import com.ezdms.bean.Mail;
import com.ezdms.bean.Note;
import com.ezdms.bean.PropertyGroup;
import com.ezdms.bean.QueryResult;
import com.ezdms.bean.Version;
import com.ezdms.bean.form.Button;
import com.ezdms.bean.form.CheckBox;
import com.ezdms.bean.form.Download;
import com.ezdms.bean.form.FormElement;
import com.ezdms.bean.form.Input;
import com.ezdms.bean.form.Node;
import com.ezdms.bean.form.Option;
import com.ezdms.bean.form.Print;
import com.ezdms.bean.form.Select;
import com.ezdms.bean.form.Separator;
import com.ezdms.bean.form.SuggestBox;
import com.ezdms.bean.form.Text;
import com.ezdms.bean.form.TextArea;
import com.ezdms.bean.form.Upload;
import com.ezdms.bean.form.Validator;
import com.ezdms.bean.workflow.Comment;
import com.ezdms.bean.workflow.ProcessDefinition;
import com.ezdms.bean.workflow.ProcessInstance;
import com.ezdms.bean.workflow.TaskInstance;
import com.ezdms.bean.workflow.Token;
import com.ezdms.bean.workflow.Transition;
...
import com.ezdms.dao.KeyValueDAO;
import com.ezdms.dao.bean.Activity;
import com.ezdms.dao.bean.Bookmark;
import com.ezdms.dao.bean.KeyValue;
import com.ezdms.dao.bean.Language;
import com.ezdms.dao.bean.MimeType;
...
import com.ezdms.extension.dao.bean.Forum;
import com.ezdms.extension.dao.bean.ForumPost;
import com.ezdms.extension.dao.bean.ForumTopic;
import com.ezdms.extension.dao.bean.MessageReceived;
import com.ezdms.extension.dao.bean.MessageSent;
import com.ezdms.extension.dao.bean.ProposedQueryReceived;
import com.ezdms.extension.dao.bean.ProposedQuerySent;
import com.ezdms.extension.dao.bean.ProposedSubscriptionReceived;
import com.ezdms.extension.dao.bean.ProposedSubscriptionSent;
import com.ezdms.extension.dao.bean.Staple;
import com.ezdms.extension.dao.bean.StapleGroup;
import com.ezdms.extension.dao.bean.WikiPage;
import com.ezdms.frontend.client.bean.GWTAppVersion;
import com.ezdms.frontend.client.bean.GWTBookmark;
import com.ezdms.frontend.client.bean.GWTComment;
import com.ezdms.frontend.client.bean.GWTConfig;
import com.ezdms.frontend.client.bean.GWTDashboardDocumentResult;
import com.ezdms.frontend.client.bean.GWTDashboardFolderResult;
import com.ezdms.frontend.client.bean.GWTDashboardMailResult;
import com.ezdms.frontend.client.bean.GWTDocument;
import com.ezdms.frontend.client.bean.GWTExtendedAttributes;
import com.ezdms.frontend.client.bean.GWTFilebrowseExtraColumn;
import com.ezdms.frontend.client.bean.GWTFolder;
import com.ezdms.frontend.client.bean.GWTKeyValue;
import com.ezdms.frontend.client.bean.GWTLanguage;
import com.ezdms.frontend.client.bean.GWTLockInfo;
import com.ezdms.frontend.client.bean.GWTMail;
import com.ezdms.frontend.client.bean.GWTMimeType;
import com.ezdms.frontend.client.bean.GWTNote;
import com.ezdms.frontend.client.bean.GWTOmr;
import com.ezdms.frontend.client.bean.GWTProcessDefinition;
import com.ezdms.frontend.client.bean.GWTProcessInstance;
import com.ezdms.frontend.client.bean.GWTProcessInstanceLogEntry;
import com.ezdms.frontend.client.bean.GWTPropertyGroup;
import com.ezdms.frontend.client.bean.GWTPropertyParams;
import com.ezdms.frontend.client.bean.GWTQueryParams;
import com.ezdms.frontend.client.bean.GWTQueryResult;
import com.ezdms.frontend.client.bean.GWTReport;
import com.ezdms.frontend.client.bean.GWTTaskInstance;
import com.ezdms.frontend.client.bean.GWTToken;
import com.ezdms.frontend.client.bean.GWTTransition;
import com.ezdms.frontend.client.bean.GWTUser;
import com.ezdms.frontend.client.bean.GWTUserConfig;
import com.ezdms.frontend.client.bean.GWTVersion;
import com.ezdms.frontend.client.bean.GWTWorkflowComment;
import com.ezdms.frontend.client.bean.GWTWorkspace;
import com.ezdms.frontend.client.bean.extension.GWTActivity;
import com.ezdms.frontend.client.bean.extension.GWTForum;
import com.ezdms.frontend.client.bean.extension.GWTForumPost;
import com.ezdms.frontend.client.bean.extension.GWTForumTopic;
import com.ezdms.frontend.client.bean.extension.GWTMessageReceived;
import com.ezdms.frontend.client.bean.extension.GWTProposedQueryReceived;
import com.ezdms.frontend.client.bean.extension.GWTProposedQuerySent;
import com.ezdms.frontend.client.bean.extension.GWTProposedSubscriptionReceived;
import com.ezdms.frontend.client.bean.extension.GWTProposedSubscriptionSent;
import com.ezdms.frontend.client.bean.extension.GWTStaple;
import com.ezdms.frontend.client.bean.extension.GWTStapleGroup;
import com.ezdms.frontend.client.bean.extension.GWTTextMessageSent;
import com.ezdms.frontend.client.bean.extension.GWTWikiPage;
import com.ezdms.frontend.client.bean.form.GWTButton;
import com.ezdms.frontend.client.bean.form.GWTCheckBox;
import com.ezdms.frontend.client.bean.form.GWTDownload;
import com.ezdms.frontend.client.bean.form.GWTFormElement;
import com.ezdms.frontend.client.bean.form.GWTInput;
import com.ezdms.frontend.client.bean.form.GWTNode;
import com.ezdms.frontend.client.bean.form.GWTOption;
import com.ezdms.frontend.client.bean.form.GWTPrint;
import com.ezdms.frontend.client.bean.form.GWTSelect;
import com.ezdms.frontend.client.bean.form.GWTSeparator;
import com.ezdms.frontend.client.bean.form.GWTSuggestBox;
import com.ezdms.frontend.client.bean.form.GWTText;
import com.ezdms.frontend.client.bean.form.GWTTextArea;
import com.ezdms.frontend.client.bean.form.GWTUpload;
import com.ezdms.frontend.client.bean.form.GWTValidator;
import com.ezdms.module.db.DbPropertyGroupModule;
import com.ezdms.principal.PrincipalAdapterException;
import com.ezdms.util.WorkflowUtils.ProcessInstanceLogEntry;
...
public class GWTUtil {
	 ...
	 */
	public static GWTConfig copy(com.ezdms.dao.bean.Config config) {
