...
import com.ezdms.bean.FileUploadResponse;
import com.ezdms.bean.Mail;
import com.ezdms.bean.Repository;
import com.ezdms.core.*;
import com.ezdms.dao.MailAccountDAO;
import com.ezdms.dao.bean.MailAccount;
import com.ezdms.dao.bean.MailFilter;
import com.ezdms.dao.bean.MailFilterRule;
import com.ezdms.dao.bean.MailImportError;
import com.ezdms.extension.core.ExtensionException;
import com.ezdms.module.db.DbDocumentModule;
import com.ezdms.module.db.DbMailModule;
...
public class MailUtils {
	...
	/**
	 * Send document to non-registered ezDMS users
	 *
	 * @param toAddress Destination addresses.
	 * @param subject The mail subject.
	...
	private static Session getMailSession() {
		...
		try {
			...
			Object obj = initialContext.lookup(Config.JNDI_BASE + "mail/ezDMS");
	...
	private static String importMessages(String token, Message messages[], Folder folder, MailAccount ma)
		...
		for (int i = 0; i < messages.length; i++) {
			...
			try {
				com.ezdms.bean.Mail mail = messageToMail(msg);
	...
	public static Mail messageToMail(Message msg) throws MessagingException, IOException {
		com.ezdms.bean.Mail mail = new com.ezdms.bean.Mail();
	...
	/**
	 * Import mail into ezDMS repository
	 */
	public static void importMail(String token, String mailPath, boolean grouping, Folder folder, Message msg, MailAccount ma,
	                              com.ezdms.bean.Mail mail) throws DatabaseException, RepositoryException, AccessDeniedException, ItemExistsException,
	 ...
	 */
	public static boolean checkRules(com.ezdms.bean.Mail mail, Set<MailFilterRule> filterRules) {
	...
	private static String createGroupPath(String token, String mailPath, Calendar receivedDate) throws DatabaseException,
		...
		if (!okmRepository.hasNode(token, path)) {
			com.ezdms.bean.Folder fld = new com.ezdms.bean.Folder();
			fld.setPath(path);
	 ...
	 */
	public static void addAttachments(String token, com.ezdms.bean.Mail mail, Part p, String userId) throws MessagingException,
	 ...
	 * Add attachments to an imported mail.
	 */
	public static void addAttachments(String token, com.ezdms.bean.Mail mail, MAPIMessage msg, String userId) throws DatabaseException,
	 ...
	 * Add attachments to an imported mail.
	 */
	public static void addAttachments(String token, com.ezdms.bean.Mail mail, com.auxilii.msgparser.Message msg, String userId)
