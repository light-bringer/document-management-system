...
public class RepositoryExporter {
	...
	/**
	 * Export mail from ezDMS repository to filesystem.
	 */
	...
	/**
	 * Export document from ezDMS repository to filesystem.
	 */
