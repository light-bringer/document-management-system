...
package com.ezdms.extension.frontend.client.widget.wiki;

import com.google.gwt.user.client.ui.Widget;
import com.ezdms.extension.frontend.client.widget.wiki.finddocument.FindDocumentSelectPopup;
import com.ezdms.extension.frontend.client.widget.wiki.findfolder.FindFolderSelectPopup;
import com.ezdms.extension.frontend.client.widget.wiki.findwiki.FindWikiSelectPopup;
...
public class Wiki implements LanguageHandlerExtension {
	...
	public native void initJavaScriptApi(Wiki wiki) /*-{
        $wnd.jsOpenWikiPage = function (wikiTitle) {
            @com.ezdms.extension.frontend.client.widget.wiki.Wiki::openWikiPage(Ljava/lang/String;)(wikiTitle);
            return true;
        }
