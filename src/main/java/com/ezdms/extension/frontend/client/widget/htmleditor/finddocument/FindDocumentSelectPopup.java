...
package com.ezdms.extension.frontend.client.widget.htmleditor.finddocument;
...
import com.ezdms.frontend.client.constants.ui.UIGeneralConstants;
...
import com.ezdms.frontend.client.extension.comunicator.UtilComunicator;
import com.ezdms.frontend.client.service.OKMSearchService;
import com.ezdms.frontend.client.service.OKMSearchServiceAsync;
import com.ezdms.frontend.client.util.EventUtils;
...
public class FindDocumentSelectPopup extends DialogBox {
	...
	public native void initJavaScriptApi(FindDocumentSelectPopup findDocumentSelectPopup) /*-{
        $wnd.jsSearchDocumentHTMLEditorPopup = function () {
            findDocumentSelectPopup.@com.ezdms.extension.frontend.client.widget.htmleditor.finddocument.FindDocumentSelectPopup::showFindDocument()();
            return true;
        }
        $wnd.jsSearchImageHTMLEditorPopup = function () {
            findDocumentSelectPopup.@com.ezdms.extension.frontend.client.widget.htmleditor.finddocument.FindDocumentSelectPopup::showFindImage()();
            return true;
        }
    }-*/;
}