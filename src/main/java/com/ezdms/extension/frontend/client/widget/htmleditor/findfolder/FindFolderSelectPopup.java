...
package com.ezdms.extension.frontend.client.widget.htmleditor.findfolder;
...
public class FindFolderSelectPopup extends DialogBox {
	...
	public native void initJavaScriptApi(FindFolderSelectPopup findFolderSelectPopup) /*-{
        $wnd.jsSearchFolderHTMLEditorPopup = function () {
            findFolderSelectPopup.@com.ezdms.extension.frontend.client.widget.htmleditor.findfolder.FindFolderSelectPopup::center()();
            return true;
        }
    }-*/;
}