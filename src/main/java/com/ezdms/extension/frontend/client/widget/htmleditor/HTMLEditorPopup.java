...
import com.ezdms.frontend.client.constants.ui.UIDialogConstants;
...
public class HTMLEditorPopup extends DialogBox {
	...
	public native void initJavaScriptApi(HTMLEditorPopup hTMLEditorPopup) /*-{
        $wnd.jsHideHTMLEditorPopup = function () {
            hTMLEditorPopup.@com.ezdms.extension.frontend.client.widget.htmleditor.HTMLEditorPopup::hide()();
            return true;
        }

        $wnd.jsHTMLEditorCheckin = function (s) {
            hTMLEditorPopup.@com.ezdms.extension.frontend.client.widget.htmleditor.HTMLEditorPopup::jsHTMLEditorCheckin(Ljava/lang/String;)(s);
            return true;
        }
    }-*/;
}