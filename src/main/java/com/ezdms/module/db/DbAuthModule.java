...
import com.ezdms.bean.ChangeSecurityParams;
...
import com.ezdms.dao.bean.PendingTask;
import com.ezdms.module.AuthModule;
...
import com.ezdms.util.GenericHolder;
...
public class DbAuthModule implements AuthModule, ApplicationContextAware {
	...
	public void login() throws RepositoryException, DatabaseException {
		...
		try {
			...
			if (auth != null) {
				...
				// Activity log
				// @see com.ezdms.spring.LoggerListener
			} else {
	...
	/*
	 * ------------------------------------------------------------------
	 * These methods only works if using the ezDMS user database.
	 * ------------------------------------------------------------------
	 */
	@Override
