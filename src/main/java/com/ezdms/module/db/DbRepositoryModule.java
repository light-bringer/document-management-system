...
import com.ezdms.dao.NodeFolderDAO;
import com.ezdms.dao.RegisteredPropertyGroupDAO;
import com.ezdms.dao.bean.NodeFolder;
import com.ezdms.dao.bean.RegisteredPropertyGroup;
import com.ezdms.module.RepositoryModule;
import com.ezdms.module.db.base.BaseFolderModule;
import com.ezdms.module.db.stuff.DbSessionManager;
import com.ezdms.spring.PrincipalUtils;
import com.ezdms.util.*;
import com.ezdms.util.impexp.RepositoryExporter;
...
public class DbRepositoryModule implements RepositoryModule {
	...
	/**
	 * Create ezDMS repository structure
	 */
	public synchronized static String create() throws RepositoryException, DatabaseException {
		...
		try {
			if (okmRootNode == null) {
				...
				com.ezdms.dao.bean.Config cfg = new com.ezdms.dao.bean.Config();

				// Generate installation UUID
				String uuid = UUID.randomUUID().toString();
				cfg.setType(com.ezdms.dao.bean.Config.HIDDEN);
				...
				com.ezdms.dao.bean.Config cfg = ConfigDAO.findByPk(Config.PROPERTY_REPOSITORY_UUID);
