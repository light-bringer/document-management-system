...
package com.ezdms.frontend.client.panel.top;
...
import com.ezdms.frontend.client.widget.TabWorkspace;
import com.ezdms.frontend.client.widget.mainmenu.MainMenu;
import com.ezdms.frontend.client.widget.toolbar.ToolBar;
...
public class TopPanel extends Composite {
	...
	public TopPanel() {
		...
		ezdmsVersion = new HTML(""); // ezDMS Professional is not shown
		ezdmsVersion.setStyleName("okm-NoWrap");
		quickSearchPanel.add(ezdmsVersion);
		...
		quickSearchPanel.setCellVerticalAlignment(ezdmsVersion, HasAlignment.ALIGN_MIDDLE);
