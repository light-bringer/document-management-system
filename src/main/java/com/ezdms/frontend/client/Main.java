...
package com.ezdms.frontend.client;
...
import com.ezdms.frontend.client.bean.RepositoryContext;
import com.ezdms.frontend.client.extension.comunicator.NavigatorComunicator;
import com.ezdms.frontend.client.extension.event.HasLanguageEvent;
import com.ezdms.frontend.client.extension.event.handler.LanguageHandlerExtension;
import com.ezdms.frontend.client.extension.event.hashandler.HasLanguageHandlerExtension;
import com.ezdms.frontend.client.panel.ExtendedDockPanel;
import com.ezdms.frontend.client.service.*;
import com.ezdms.frontend.client.util.*;
import com.ezdms.frontend.client.widget.*;
import com.ezdms.frontend.client.widget.chat.OnlineUsersPopup;
import com.ezdms.frontend.client.widget.finddocument.FindDocumentSelectPopup;
import com.ezdms.frontend.client.widget.findfolder.FindFolderSelectPopup;
import com.ezdms.frontend.client.widget.findsimilar.FindSimilarDocumentSelectPopup;
import com.ezdms.frontend.client.widget.foldertree.FolderTree;
import com.ezdms.frontend.client.widget.massive.*;
import com.ezdms.frontend.client.widget.notify.NotifyPopup;
import com.ezdms.frontend.client.widget.security.SecurityPopup;
import com.ezdms.frontend.client.widget.startup.StartUp;
import com.ezdms.frontend.client.widget.startup.StartUpPopup;
import com.ezdms.frontend.client.widget.test.TestPopup;
import com.ezdms.frontend.client.widget.upload.FileUploadPopup;
import com.ezdms.frontend.client.widget.wizard.TemplateWizardPopup;
import com.ezdms.frontend.client.widget.wizard.WizardPopup;
...
public final class Main implements EntryPoint, HasLanguageHandlerExtension, HasLanguageEvent {
	public static String CONTEXT = "/ezDMS";
	...
	native void initJavaScriptApi() /*-{
        ...
        $wnd.i18n = function (s) {
            return @com.ezdms.frontend.client.Main::i18n(Ljava/lang/String;)(s);
        };
