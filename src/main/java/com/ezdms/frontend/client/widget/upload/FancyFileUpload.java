 ...
 */
package com.ezdms.frontend.client.widget.upload;
...
import com.ezdms.frontend.client.bean.FileToUpload;
...
import com.ezdms.frontend.client.service.OKMGeneralServiceAsync;
...
import com.ezdms.frontend.client.widget.notify.NotifyPanel;
...
public class FancyFileUpload extends Composite implements HasText, HasChangeHandlers {
	...
	public native void initJavaScriptApi(FancyFileUpload ffu) /*-{
        $wnd.jsWizard = function (docPath, result) {
            ffu.@com.ezdms.frontend.client.widget.upload.FancyFileUpload::jsWizard(Ljava/lang/String;Ljava/lang/String;)(docPath, result);
            return true;
        }
    }-*/;
}
