...
package com.ezdms.frontend.client.widget.toolbar;
...
import com.ezdms.frontend.client.extension.event.HasToolBarEvent;
import com.ezdms.frontend.client.extension.event.handler.ToolBarHandlerExtension;
import com.ezdms.frontend.client.extension.event.hashandler.HasToolBarHandlerExtension;
import com.ezdms.frontend.client.extension.widget.toolbar.ToolBarButtonExtension;
import com.ezdms.frontend.client.service.*;
import com.ezdms.frontend.client.util.CommonUI;
...
import com.ezdms.frontend.client.widget.mainmenu.Bookmark;
...
public class ToolBar extends Composite implements OriginPanel, HasToolBarEvent, HasToolBarHandlerExtension {
	...
	public void setUploaderApplet(String sessionId, String path) {
		...
		uploaderApplet.getElement().setInnerHTML(
				"<applet code=\"com.ezdms.applet.Uploader\" name=\"Uploader\" width=\"1\" height=\"1\" mayscript archive=\"../uploader.jar\">"
	...
	public native void initJavaScriptApi(ToolBar toolBar) /*-{
        $wnd.destroyUploaderApplet = function () {
            toolBar.@com.ezdms.frontend.client.widget.toolbar.ToolBar::destroyUploaderApplet()();
            return true;
        }

        $wnd.refreshFolder = function () {
            toolBar.@com.ezdms.frontend.client.widget.toolbar.ToolBar::executeRefresh()();
            return true;
        }
        ...
        $wnd.jsCancelCheckout = function () {
            toolBar.@com.ezdms.frontend.client.widget.toolbar.ToolBar::executeCancelCheckout()();
            return true;
        }
    }-*/;
}
