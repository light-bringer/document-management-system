...
import com.ezdms.frontend.client.widget.eastereggs.Futurama;
...
public class AboutPopup extends DialogBox implements ClickHandler {
	...
	private String copy = "&nbsp;&copy 2006-2018 ezDMS <br><br>";
	private String team = "<b>ezDMS Team</b><br><br>";
	private String web = "<a href=\"http://www.ezdms.com\" target=\"_blank\">http://www.ezdms.com</a><br><br>";
	...
	public AboutPopup() {
		...
		logo = new Image("img/logo_ezdms.gif");
	...
	public void show() {
		setText(Main.i18n("about.label"));
		text.setHTML(msg);
		logo.setUrl("img/logo_ezdms.gif");
		reset();
		super.show();
	}
