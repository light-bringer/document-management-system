...
package com.ezdms.frontend.client.widget.filebrowser;
...
import com.ezdms.extension.frontend.client.widget.htmleditor.HTMLEditor;
import com.ezdms.frontend.client.Main;
import com.ezdms.frontend.client.bean.*;
import com.ezdms.frontend.client.constants.ui.UIDesktopConstants;
import com.ezdms.frontend.client.constants.ui.UIFileUploadConstants;
import com.ezdms.frontend.client.extension.event.HasDocumentEvent;
import com.ezdms.frontend.client.extension.event.HasFolderEvent;
import com.ezdms.frontend.client.extension.event.HasMailEvent;
import com.ezdms.frontend.client.extension.event.handler.DocumentHandlerExtension;
import com.ezdms.frontend.client.extension.event.handler.FolderHandlerExtension;
import com.ezdms.frontend.client.extension.event.handler.MailHandlerExtension;
import com.ezdms.frontend.client.extension.event.hashandler.HasDocumentHandlerExtension;
import com.ezdms.frontend.client.extension.event.hashandler.HasFolderHandlerExtension;
import com.ezdms.frontend.client.extension.event.hashandler.HasMailHandlerExtension;
import com.ezdms.frontend.client.service.*;
import com.ezdms.frontend.client.util.OKMBundleResources;
import com.ezdms.frontend.client.util.ScrollTableHelper;
import com.ezdms.frontend.client.util.Util;
import com.ezdms.frontend.client.widget.ConfirmPopup;
import com.ezdms.frontend.client.widget.MenuPopup;
import com.ezdms.frontend.client.widget.OriginPanel;
import com.ezdms.frontend.client.widget.filebrowser.menu.*;
...
public class FileBrowser extends Composite implements OriginPanel, HasDocumentEvent, HasFolderEvent, HasMailEvent,
	...
	private com.ezdms.frontend.client.widget.massive.Status massiveStatus;
	...
	public FileBrowser() {
		...
		massiveStatus = new com.ezdms.frontend.client.widget.massive.Status(this);
