...
import com.ezdms.frontend.client.service.OKMChatService;
import com.ezdms.frontend.client.service.OKMChatServiceAsync;
import com.ezdms.frontend.client.util.OKMBundleResources;
import com.ezdms.frontend.client.util.Util;
import com.ezdms.frontend.client.widget.chat.ChatRoomDialogBox;
import com.ezdms.frontend.client.widget.chat.ChatRoomPopup;
...
public class UserInfo extends Composite {
	...
	public UserInfo() {
		...
		img = new Image(OKMBundleResources.INSTANCE.ezdmsConnected());
