...
package com.ezdms.frontend.client.widget.searchin;
...
import com.ezdms.frontend.client.constants.ui.UISearchConstants;
...
public class SearchControl extends Composite {
	...
	public SearchControl() {
		...
		searchTypePanel.setVisible(true);  // On ezDMS 4.0 has hidden AND / OR option list
