...
import com.ezdms.frontend.client.bean.GWTUINotification;
...
public class CommonUI {
	...
	public native void initJavaScriptApi(CommonUI commonUI) /*-{
        $wnd.openPathByUuid = function (uuid) {
            @com.ezdms.frontend.client.util.CommonUI::openPathByUuid(Ljava/lang/String;)(uuid);
            return true;
        }
        $wnd.openPath = function (folderPath, docPath) {
            @com.ezdms.frontend.client.util.CommonUI::openPath(Ljava/lang/String;Ljava/lang/String;)(folderPath, docPath);
            return true;
        };
        ...
        $wnd.jsOpenUserTaskInstance = function (taskInstanceId) {
            @com.ezdms.frontend.client.util.CommonUI::openUserTaskInstance(Ljava/lang/String;)(taskInstanceId);
            return true;
        };
    }-*/;
}