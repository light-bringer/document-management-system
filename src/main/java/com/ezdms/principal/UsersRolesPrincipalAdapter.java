...
public class UsersRolesPrincipalAdapter implements PrincipalAdapter {
	...
	public List<String> getUsers() throws PrincipalAdapterException {
		...
		try {
			prop.load(new FileInputStream(Config.HOME_DIR + "/server/default/conf/props/ezdms-users.properties"));
	...
	public List<String> getRoles() throws PrincipalAdapterException {
		...
		try {
			prop.load(new FileInputStream(Config.HOME_DIR + "/server/default/conf/props/ezdms-roles.properties"));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public String getMail(String user) throws PrincipalAdapterException {
		...
		try {
			prop.load(new FileInputStream(Config.HOME_DIR + "/server/default/conf/props/ezdms-emails.properties"));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public String getName(String user) throws PrincipalAdapterException {
		...
		try {
			prop.load(new FileInputStream(Config.HOME_DIR + "/server/default/conf/props/ezdms-names.properties"));
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
