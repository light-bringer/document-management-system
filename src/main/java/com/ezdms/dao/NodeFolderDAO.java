...
public class NodeFolderDAO {
	...
	private static final String CACHE_FOLDERS_BY_CATEGORY = "com.ezdms.cache.foldersByCategory";
	private static final String CACHE_FOLDERS_BY_KEYWORD = "com.ezdms.cache.foldersByKeyword";
