...
public class NodeMailDAO {
	...
	private static final String CACHE_MAILS_BY_CATEGORY = "com.ezdms.cache.mailsByCategory";
	private static final String CACHE_MAILS_BY_KEYWORD = "com.ezdms.cache.mailsByKeyword";
