...
/**
 * Search results are filtered by com.ezdms.module.db.stuff.ReadAccessFilterFactory, which limit the results only for
...
public class SearchDAO {
	...
	private static final String CACHE_SEARCH_FOLDERS_IN_DEPTH = "com.ezdms.cache.searchFoldersInDepth";
