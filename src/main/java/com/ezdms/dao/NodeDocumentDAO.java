...
package com.ezdms.dao;

import com.cybozu.labs.langdetect.Detector;
import com.cybozu.labs.langdetect.DetectorFactory;
import com.cybozu.labs.langdetect.LangDetectException;
import com.ezdms.automation.AutomationManager;
...
import com.ezdms.dao.bean.*;
import com.ezdms.extension.dao.ForumDAO;
import com.ezdms.extension.dao.StapleGroupDAO;
import com.ezdms.extension.dao.WikiPageDAO;
import com.ezdms.extractor.RegisteredExtractors;
import com.ezdms.extractor.TextExtractorWork;
import com.ezdms.module.common.CommonGeneralModule;
import com.ezdms.module.db.stuff.FsDataStore;
import com.ezdms.module.db.stuff.LockHelper;
import com.ezdms.module.db.stuff.SecurityHelper;
import com.ezdms.spring.PrincipalUtils;
import com.ezdms.util.*;
import com.ezdms.vernum.VersionNumerationAdapter;
import com.ezdms.vernum.VersionNumerationFactory;
...
public class NodeDocumentDAO {
	...
	private static final String CACHE_DOCUMENTS_BY_CATEGORY = "com.ezdms.cache.documentsByCategory";
	private static final String CACHE_DOCUMENTS_BY_KEYWORD = "com.ezdms.cache.documentsByKeyword";
	...
	public void delete(String name, String uuid, String trashUuid) throws PathNotFoundException, AccessDeniedException, LockException,
		...
		try {
			...
			String fileName = com.ezdms.util.FileUtils.getFileName(name);
			String fileExtension = com.ezdms.util.FileUtils.getFileExtension(name);
	 ...
	 *
	 * @see com.ezdms.dao.NodeFolderDAO.purgeHelper(Session, NodeFolder, boolean)
	 * @see com.ezdms.dao.NodeMailDAO.purgeHelper(Session, NodeMail)
	 */
	@SuppressWarnings("unchecked")
	 ...
	 *
	 * @see com.ezdms.module.nr.NrStatsModule
	 */
