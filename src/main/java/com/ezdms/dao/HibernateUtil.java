...
import com.ezdms.extension.dao.bean.ZohoToken;
import com.ezdms.util.ConfigUtils;
import com.ezdms.util.DatabaseDialectAdapter;
import com.ezdms.util.EnvironmentDetector;
import com.ezdms.util.FileUtils;
...
public class HibernateUtil {
	...
	private static Configuration getConfiguration() {
		...
		cfg.addAnnotatedClass(com.ezdms.dao.bean.Config.class);
