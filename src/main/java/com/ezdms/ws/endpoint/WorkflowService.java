...
import com.ezdms.module.WorkflowModule;
import com.ezdms.ws.util.FormElementComplex;
...
@WebService(name = "OKMWorkflow", serviceName = "OKMWorkflow", targetNamespace = "http://ws.ezdms.com")
