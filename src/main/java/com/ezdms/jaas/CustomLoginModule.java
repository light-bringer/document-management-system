...
package com.ezdms.jaas;

import com.ezdms.module.common.CommonAuthModule;
import com.ezdms.principal.PrincipalAdapter;
 ...
 *
 * ezDMS {
 *   com.ezdms.jaas.CustomLoginModule REQUIRED debug=true;
 * };
 *
 * @author pavila
 */
public class CustomLoginModule implements LoginModule {
	...
	public static void main(String args[]) throws LoginException {
		if (args.length != 2) {
			...
			LoginContext lc = new LoginContext("ezDMS", mch);
			lc.login();
