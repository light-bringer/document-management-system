...
public class DashboardServlet extends HttpServlet {
	...
	private void lastModified(HttpServletRequest request, HttpServletResponse response) throws
		...
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getUserLastModifiedDocuments());
	...
	private void lastUploaded(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getUserLastUploadedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void checkout(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getUserCheckedOutDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void downloaded(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getUserLastDownloadedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void locked(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getUserLockedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void generalLastWeekViewed(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getLastWeekTopDownloadedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void generalLastMonthViewed(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getLastMonthTopDownloadedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void generalLastWeekModified(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getLastWeekTopModifiedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void generalLastMonthModified(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getLastMonthTopModifiedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void generalLastUploaded(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getLastUploadedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
	...
	private void generalLastModified(HttpServletRequest request, HttpServletResponse response) throws
		...
		ServletContext sc = getServletContext();
		sc.setAttribute("action", WebUtils.getString(request, "action"));
		sc.setAttribute("dashboardDocs", new com.ezdms.servlet.frontend.DashboardServlet().getLastModifiedDocuments());
		sc.getRequestDispatcher("/" + Config.MOBILE_CONTEXT + "/dashboard_browse.jsp").forward(request, response);
	}
}