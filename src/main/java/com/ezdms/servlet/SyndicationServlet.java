...
import com.ezdms.dao.QueryParamsDAO;
import com.ezdms.dao.bean.QueryParams;
import com.ezdms.module.db.DbDashboardModule;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			...
			if ("/userLockedDocuments".equals(action)) {
				...
				feed.setTitle("ezDMS: user locked documents");
				...
				feed.setTitle("ezDMS: user checked-out documents");
				...
				feed.setTitle("ezDMS: user last uploaded documents");
				...
				feed.setTitle("ezDMS: user last modified documents");
				...
				feed.setTitle("ezDMS: user last imported mail attachments");
				...
				feed.setTitle("ezDMS: last week top downloaded documents");
				...
				feed.setTitle("ezDMS: last month top downloaded documents");
				...
				feed.setTitle("ezDMS: last week top modified documents");
				...
				feed.setTitle("ezDMS: last month top modified documents");
				...
				feed.setTitle("ezDMS: last modified documents");
				...
				feed.setTitle("ezDMS: last uploaded documents");
				...
				feed.setTitle("ezDMS: " + qp.getQueryName());
			}
