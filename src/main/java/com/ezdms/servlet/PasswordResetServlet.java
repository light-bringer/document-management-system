...
import com.ezdms.jaas.PrincipalUtils;
import com.ezdms.module.db.stuff.DbSessionManager;
import com.ezdms.spring.SecurityHolder;
		...
		if (Config.USER_PASSWORD_RESET) {
			...
			if (usr != null) {
				try {
					...
					MailUtils.sendMessage(usr.getEmail(), usr.getEmail(), "ezDMS Password reset", "Your new password is: " + newPass
