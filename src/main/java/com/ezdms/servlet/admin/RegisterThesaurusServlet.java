...
import com.ezdms.kea.tree.KEATree;
...
public class RegisterThesaurusServlet extends BaseServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException,
		...
		if (!Config.KEA_THESAURUS_OWL_FILE.equals("")) {
			...
			out.println("<b>Don't close this window meanwhile ezDMS is creating thesaurus.</b><br>");
			...
			out.println("<b>Error - there's no thesaurus file defined in ezDMS.cfg</b>");
		}
