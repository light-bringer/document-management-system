...
<%@ page import="com.ezdms.api.OKMRepository" %>
<%@ page import="com.ezdms.servlet.admin.BaseServlet" %>
<%@ page import="com.ezdms.util.WarUtils" %>
...
<body>
  ...
  <c:choose>
    <c:when test="${isAdmin}">
      <ul id="breadcrumb">
        <li class="path">
          <a href="home.jsp">ezDMS Administration</a>
        </li>
      </ul>
      <br/>
      <table width="234px" class="form" style="margin-top: 25px">
        <tr><td><b>ezDMS - Knowledge Management</b></td></tr>
        <tr><td nowrap="nowrap">Version: <%=WarUtils.getAppVersion() %></td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td>&copy; 2006-2018 ezDMS</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td><b>Support</b></td></tr>
        <tr><td><a target="_blank" href="http://forum.ezdms.com/">http://forum.ezdms.com</a></td></tr>
        <tr><td>&nbsp;</td></tr>
